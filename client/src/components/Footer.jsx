...
const Footer = () => (
  <div className="flex flex-col items-center justify-between w-full p-4 md:justify-center gradient-bg-footer">
    ...
    <div className="flex flex-col items-center justify-center mt-5">
      <p className="text-sm text-center text-white">Hit me up</p>
      <button className="mt-2 text-sm font-medium text-center text-white">
    ...
    <div className="sm:w-[90%] w-full flex justify-between items-center mt-3">
      {/* <p className="text-xs text-left text-white">@Jake Damon 2022</p> */}
